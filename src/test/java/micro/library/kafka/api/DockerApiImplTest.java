package micro.library.kafka.api;

import micro.library.kafka.domain.DockerContainer;
...
class DockerApiImplTest {
    ...
    void run() {
        ...
        assertEquals("[kafka, run, --rm, --name, TEST_NAME, -e, TEST_ENVIRONMENT, -v, TEST_VOLUME:TEST_VOLUME, TEST_IMAGE]", processBuilder.command().toString());
    }
